...
| ВИКЛЮЧНІ СИТУАЦІЇ                      | <ul><li>`CreateTask_AccessDeniedEXC`<br>учасник проєкту не має прав на створення завдання</li><li>`CreateTask_MissingDataEXC`<br>учасник проєкту не заповнив необхідні поля</li><li>`CreateTask_InvalidDataEXC`<br>учасник проєкту надав некортені дані для створення проєкту</li></ul> |
...
:Зберігає внесенні зміни та відображає\nвідредаговане завдання;
